    ...
    <div className="">
      ...
      <div className="flex justify-between items-center px-10 bg-yellow-400 border-y border-black py-16 lg:py-20 ">
        ...
        <img
          ...
          src="https://www.nicepng.com/png/full/48-483810_medium-logo-png.png"
          alt=""
        />
      </div>
        ...
        {posts.map((post) => (
          <Link key={post._id} href={`/post/${post.slug.current}`}>
            <div className="group cursor-pointer border rounded-lg overflow-hidden">
              <img
                className="h-60 w-full object-cover group-hover:scale-105 transition-transform duration-200 ease-in-out rounded-md"
